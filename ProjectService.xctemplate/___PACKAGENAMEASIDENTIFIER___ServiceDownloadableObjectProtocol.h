...
@protocol ___PROJECTNAMEASIDENTIFIER___ServiceDownloadableObjectProtocol <NSObject>
...
+ (void)___VARIABLE_categoryPrefix:identifier____deleteStaticResponseMappingObjects;
